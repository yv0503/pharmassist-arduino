...
void AlarmHandler::initialize(const uint8_t alarm_pin) {
    pinMode(alarm_pin, OUTPUT);
}

void AlarmHandler::playAlarm(uint8_t alarm_pin) const {
    ...
    for (int thisNote = 0; thisNote < notes * 2; thisNote = thisNote + 2) {
        ...
        tone(alarm_pin, melody[thisNote], noteDuration * 0.9);
...
void AlarmHandler::stopAlarm(const uint8_t alarm_pin) const {
